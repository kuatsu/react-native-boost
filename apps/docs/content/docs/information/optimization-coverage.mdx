...
| --- | --- | --- |
| `Text` | Imported from `react-native`, no blacklisted props, string-safe children | `contains blacklisted props`, `contains non-primitive children`, `is a direct child of expo-router Link with asChild` |
