...
`dangerouslyOptimizeTextWithUnknownAncestors`, `dangerouslyOptimizeImageWithUnknownAncestors`, and `dangerouslyOptimizeActivityIndicatorWithUnknownAncestors` (see [Configuration](/docs/configuration/configure)).
