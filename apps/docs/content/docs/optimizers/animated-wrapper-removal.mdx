...
- The element is a direct child of a known parent, such as React Native `View` or a simple wrapper around it.
...
- An unknown parent or a parent that inspects or clones its children.
- An element passed through a prop such as `render`, a function call, or a variable.
- A component or callback that returns the Animated element without a known parent.
