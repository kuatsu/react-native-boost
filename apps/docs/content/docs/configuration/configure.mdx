...
`Image` optimization is currently opt-in because it depends on React Native's internal Image host export path. Enable it explicitly when you want to test it:
