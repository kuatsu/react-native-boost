...
export const animatedShouldDebounceQueueFlush = () => false;
export const animatedShouldUseSingleOp = () => false;
export const cxxNativeAnimatedEnabled = () => false;
export const shouldUseAnimatedObjectForTransform = () => false;
export const shouldUseSetNativePropsInFabric = () => false;
export const useSharedAnimatedBackend = () => false;
