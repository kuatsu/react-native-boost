...
const basenameRedirects: Array<[RegExp, string]> = [
  ...
  [/(^|[./])NativeAnimatedHelper$/, u('./mocks/NativeAnimatedHelper.ts')],
  [/(^|[./])RendererProxy$/, u('./mocks/RendererProxy.ts')],
  [/(^|[./])ReactNativePrivateInterface$/, u('./mocks/ReactNativePrivateInterface.ts')],
